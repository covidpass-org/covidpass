...
function Faq(): JSX.Element {
    ...
    const questionList = [
      ...
      {description: 'Why isn\'t the new Apple Wallet pass green/orange?', answer: 'Because we now allow importing of QR codes from many provinces and states, and those provinces and states have different eligibility rules, we can no longer reliably determine who is or is not fully vaccinated at receipt import time.'},
